        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-primary to-secondary px-6 py-4">
              <h2 className="text-xl font-bold text-white">Create New Column</h2>
              <p className="text-white/80 text-sm mt-1">Add a new section to your board</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              {/* Title Input */}
              <div>
                <label htmlFor="columnTitle" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                  Column Title
                </label>
                <input
                  id="columnTitle"
                  ...
                  placeholder="e.g., Review, Testing, Deployment"
                  className="
